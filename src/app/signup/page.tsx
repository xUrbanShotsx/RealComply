              ...
              <form onSubmit={handleStep3} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
                ...
                <div>
                  ...
                  <div style={{
                    ...
                    <p style={{ fontWeight: 600, color: "var(--rc-ink)", marginBottom: "6px", maxWidth: "none" }}>12. Subscription, Billing, Cancellation, and Data Retention</p>
                    <p style={{ marginBottom: "12px", maxWidth: "none" }}>Your subscription is charged on a monthly recurring basis through Stripe, following a 14-day free trial period during which your payment method is held but not charged. You may cancel at any time through your account settings; cancellation takes effect at the end of the current billing period and no partial-month refunds are issued. RealComply reserves the right to vary subscription pricing on not less than 30 days&apos; written notice. Continued use of the Platform following a pricing change constitutes acceptance of the new pricing.</p>
                    <p style={{ marginBottom: "12px", maxWidth: "none" }}>If a scheduled payment fails, your organisation&apos;s access to the Platform will be immediately suspended. Your data will be securely retained for a period of six (6) months from the date of suspension. During this retention period, access may be restored at any time by updating your payment method and resuming your subscription, whereupon full access to your organisation&apos;s data will be reinstated. If payment is not successfully processed within six (6) months of suspension, all data associated with your organisation — including but not limited to staff records, property checklists, compliance documents, trust accounting records, and all other stored information — will be permanently and irrecoverably deleted. RealComply accepts no liability for any loss arising from the deletion of data following the expiry of the six-month retention period. It is your responsibility to export or back up any data you wish to retain prior to or during any period of suspension.</p>
                ...
                <label style={{ display: "flex", alignItems: "flex-start", gap: "12px", cursor: "pointer", padding: "14px 16px", background: acknowledged ? "oklch(0.96 0.04 295)" : "var(--rc-surface-2)", border: `1.5px solid ${acknowledged ? "var(--rc-primary)" : "var(--rc-border)"}`, borderRadius: "10px", transition: "all 0.15s ease" }}>
                  ...
                  <span style={{ fontSize: "13px", color: "var(--rc-ink)", lineHeight: 1.6, maxWidth: "none" }}>
                    I confirm that I have read and understood the Disclosure Statement above. I acknowledge that RealComply is a compliance management tool only and does not constitute legal advice. I accept full responsibility for my agency&apos;s compliance with all applicable laws and regulations, and I understand that RealComply Pty Ltd is not liable for the outcome of any regulatory audit, investigation, or enforcement action. I understand that if a payment fails, my organisation&apos;s access will be suspended and my data will be permanently deleted if payment is not resumed within 6 months.
                  </span>
                </label>
