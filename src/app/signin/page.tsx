        ...
        <div style={{ width: "100%", maxWidth: "400px" }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              <label
                htmlFor="email"
                style={{ fontSize: "14px", fontWeight: 500, color: "var(--rc-ink)" }}
              >
                Email
              </label>
              <input
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "6px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "baseline" }}>
                ...
                <a
                  href="#"
                  style={{ fontSize: "13px", color: "var(--rc-primary)", fontWeight: 500 }}
                >
                  Forgot password?
                </a>
              </div>
          ...
          >
            ...
            <Link href="#signup" style={{ color: "var(--rc-primary)", fontWeight: 500 }}>
              Sign up
            </Link>
          </p>
        </div>
